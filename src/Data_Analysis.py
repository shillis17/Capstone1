...
#Initiate 12 data frames containing only games of each genre
...
#Make total revenue column for comparison
...
#Initiate data to compare mean of total revenue
...
#make a dictionary to easily compare the metacritic score to reccomendation counts
...
#Run linear regression testing to see how correlated the variables are
...
#intiate data to compare the average player retention percentage for each genre
